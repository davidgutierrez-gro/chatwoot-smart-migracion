class Api::V1::Accounts::BulkActionsController < Api::V1::Accounts::BaseController
  def create
    ...
    when 'Conversation'
      return render_unauthorized('Only administrators can assign conversations') if assignment_change_requested? && !Current.account_user&.administrator?
  ...
  def assignment_change_requested?
