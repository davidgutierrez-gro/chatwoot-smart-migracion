...
ActiveRecord::Schema[7.1].define(version: 2026_03_24_000001) do
  ...
  create_table "whatsapp_template_logs", force: :cascade do |t|
    t.bigint "account_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "created_at"], name: "index_whatsapp_template_logs_on_account_id_and_created_at"
    t.index ["account_id", "status"], name: "index_whatsapp_template_logs_on_account_id_and_status"
    t.index ["account_id"], name: "index_whatsapp_template_logs_on_account_id"
    t.index ["contact_id"], name: "index_whatsapp_template_logs_on_contact_id"
    t.index ["conversation_id"], name: "index_whatsapp_template_logs_on_conversation_id"
    t.index ["inbox_id", "status", "created_at"], name: "index_wa_template_logs_on_inbox_status_created"
    t.index ["inbox_id"], name: "index_whatsapp_template_logs_on_inbox_id"
    t.index ["message_id"], name: "index_whatsapp_template_logs_on_message_id"
    t.index ["user_id"], name: "index_whatsapp_template_logs_on_user_id"
  end
